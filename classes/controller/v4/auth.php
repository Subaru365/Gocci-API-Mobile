 ...
 * @version    4.0.2 (2016/2/11)
 * @author     Subaru365 (a-murata@inase-inc.jp)
 * @copyright  (C) 2016 Akira Murata
 * @link       https://bitbucket.org/inase/gocci-mobile-api
 */

class Controller_V4_Auth extends Controller_V4_Public
{
    ...
    private function getLoginData($identity_id)
    {
        ...
        $params['profile_img']      = Model_V4_Transcode::decode_profile_img($params['profile_img']);
